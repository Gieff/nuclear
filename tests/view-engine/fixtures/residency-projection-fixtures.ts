 ...
 *
 * Adversarial (malformed/collision/dishonest) cases live in
 * `./residency-projection-hostile-fixtures.ts`, which imports this module; this
 * module never imports it, so there is no cycle.
 *
