 ...
 * application. P4.4b adds the inter-study admission gate, registration and the
 * explicit workspace-level staged spatial propagation. No React, DOM,
