...
export const FIGURE_PUBLICATION_ERROR_CODES = {
  ...
  annotationInvalid: 'FIGURE_ANNOTATION_INVALID',
  renderUnavailable: 'FIGURE_PUBLICATION_RENDER_UNAVAILABLE',
  renderFailed: 'FIGURE_PUBLICATION_RENDER_FAILED',
  rasterInvalid: 'FIGURE_PUBLICATION_RASTER_INVALID',
  compositionInvalid: 'FIGURE_COMPOSITION_INVALID',
