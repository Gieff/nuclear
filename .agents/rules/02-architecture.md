...
| **`@nuclear/project-model`** | Persistence of NuClear `.mcv` projects, source locators/fingerprints, cached previews, and migration adapters. | `@nuclear/shared-types`, `@nuclear/rendering-presets` | NO runtime rendering dependencies. |
